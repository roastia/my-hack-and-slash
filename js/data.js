...
const combatSkills = [
    ...
    },
    {
        ...
        atbMultiplier: 0.9,
        shopCost: 100,
        desc: '毒属性の一撃。3ターン継続毒ダメージ付与。',
        levelThresholds: [0, 12, 35, 70, 110],
        dmgMults: [1.0, 1.2, 1.5, 1.9, 2.4],
        poisonTurns: 3,
    },
    {
        id: 'holyLight',
        ...
        atbMultiplier: 1.2,
        shopCost: 130,
        desc: '光属性の一撃。防御無視ダメージ+精神ボーナス。',
        levelThresholds: [0, 15, 40, 80, 130],
        dmgMults: [1.3, 1.6, 2.0, 2.5, 3.1],
        ignoresDef: true,
    },
    {
        id: 'darkBlade',
        ...
        atbMultiplier: 1.0,
        shopCost: 110,
        desc: '闇属性の大技。HP低下時ほど威力増加。',
        levelThresholds: [0, 12, 35, 70, 110],
        dmgMults: [1.5, 1.8, 2.3, 2.9, 3.6],
    },
    {
        id: 'drainStrike',
        name: 'ドレイン',
        ...
        atbMultiplier: 1.0,
        shopCost: 120,
        desc: '与ダメージの一部をHP回収（Lvで回収率UP）。',
        levelThresholds: [0, 15, 40, 80, 120],
        dmgMults: [1.0, 1.2, 1.4, 1.7, 2.0],
        drainPcts: [0.3, 0.4, 0.5, 0.65, 0.8],
    },
    {
        id: 'berserkRage',
        name: 'バーサーク',
        ...
        atbMultiplier: 0.8,
        shopCost: 100,
        desc: '3ターン ATK大幅UP（防御低下）。Lvで効果増加。',
        levelThresholds: [0, 10, 30, 60, 100],
        atkBoostMults: [1.5, 1.7, 2.0, 2.5, 3.0],
        defPenaltyMults: [0.6, 0.65, 0.7, 0.75, 0.8],
        buffTurns: 3,
    },
    {
        id: 'shieldBreak',
        ...
        atbMultiplier: 1.1,
        shopCost: 110,
        desc: '防御無視の強打。Lvで倍率増加。',
        levelThresholds: [0, 12, 35, 70, 110],
        dmgMults: [2.0, 2.4, 3.0, 3.7, 4.5],
        ignoresDef: true,
    },
    {
        id: 'sureShot',
    ...
    },
    {
        ...
        atbMultiplier: 1.8,
        shopCost: 200,
        desc: '全SP消費して超強力な一撃。Lvで倍率増加。',
        levelThresholds: [0, 20, 50, 90, 140],
        dmgMults: [3.0, 3.8, 4.8, 6.0, 8.0],
        consumesAllSp: true,
    },
];
...
const medalCatalog = [
    ...
    // ── 拡充メダル ─────────────────────────────────────────────────────
    { id: 'medal_atk2',   name: '覇王の章',    apCost: 6, meritCost: 40, desc: 'ATK +50%',          effects: { atkMult: 1.5 } },
    { id: 'medal_def2',   name: '城壁の章',    apCost: 4, meritCost: 25, desc: 'DEF +8',             effects: { defBonus: 8 } },
    { id: 'medal_hp2',    name: '不死の章',    apCost: 5, meritCost: 35, desc: '最大HP +40%',        effects: { hpMult: 1.4 } },
    { id: 'medal_magic',  name: '魔王の章',    apCost: 5, meritCost: 35, desc: '魔法ATK +50%',       effects: { magicMult: 1.5 } },
    { id: 'medal_steal',  name: '盗賊の章',    apCost: 3, meritCost: 20, desc: '奪取率 +20%',        effects: { stealBonus: 20 } },
    { id: 'medal_gold',   name: '商人の章',    apCost: 3, meritCost: 18, desc: 'G獲得 +50%',         effects: { goldMult: 1.5 } },
    { id: 'medal_spd2',   name: '疾風の章',    apCost: 5, meritCost: 30, desc: 'SPD +15',            effects: { spdBonus: 15 } },
    { id: 'medal_crit2',  name: '凶刃の章',    apCost: 5, meritCost: 35, desc: 'クリ率 +25%',        effects: { critBonus: 25 } },
    { id: 'medal_exp2',   name: '大賢者の章',  apCost: 4, meritCost: 28, desc: 'EXP +80%',           effects: { expMult: 1.8 } },
    { id: 'medal_drain2', name: '吸魂の章',    apCost: 6, meritCost: 45, desc: '吸血率 +20%',        effects: { drainBonus: 20 } },
    { id: 'medal_sp2',    name: '霊泉の章',    apCost: 3, meritCost: 20, desc: '最大SP +60',         effects: { spBonus: 60 } },
    { id: 'medal_spirit2',name: '大霊の章',    apCost: 4, meritCost: 22, desc: '精神 +15',           effects: { spiritBonus: 15 } },
    { id: 'medal_regen',  name: '回復の章',    apCost: 3, meritCost: 20, desc: 'SPリジェネ+2/turn',  effects: { spRegen: 2 } },
    { id: 'medal_mat',    name: '採掘の章',    apCost: 2, meritCost: 15, desc: '素材ドロップ +50%',  effects: { matDropMult: 1.5 } },
    { id: 'medal_range2', name: '神弓の章',    apCost: 5, meritCost: 35, desc: '遠隔ATK +60%',       effects: { rangeMult: 1.6 } },
    { id: 'medal_allstat',name: '英雄の章',    apCost: 8, meritCost: 80, desc: 'ATK/DEF/SPD全+15%',  effects: { atkMult: 1.15, defMult: 1.15, spdBonus: 10 } },
    { id: 'medal_combo',  name: '連撃の章',    apCost: 4, meritCost: 30, desc: 'ATK+15% / 会心+10%', effects: { atkMult: 1.15, critBonus: 10 } },
    { id: 'medal_magewar',name: '魔剣の章',    apCost: 5, meritCost: 38, desc: 'ATK+20% / 魔法+30%', effects: { atkMult: 1.2, magicMult: 1.3 } },
];
